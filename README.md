...
newspace-config 입니다.
<br>
해당 레포지토리에는 컨피그 서버에서 다른 서비스들에게 필요한 application.yml의 정보들을 담고 있습니다.
<br>
...
.
├── eureka
│   └── newspace-eureka.yml // 유레카
├── gateway
│   └── newspace-gateway.yml // 게이트웨이
├── news
│   └── newspace-news-service.yml // 뉴스 서비스
├── notice
│   └── newspace-notice-service.yml // 알림 서비스
├── README.md
└── user
    └── newspace-user-service.yml // 유저 서비스
```
<br/>
